...
public class Locating_RadioButtons {
    public static void main(String[] args) {
        ...
        blueRadio.click();//mothing will happen because its already selected
